...
-- Description: Creates users, user_roles, workers, and worker_skills.
...
-- 3. Workers Table (Separate profile from Users)
CREATE TABLE IF NOT EXISTS workers (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID UNIQUE NOT NULL,
    department_id UUID NOT NULL,
    worker_status VARCHAR(50) DEFAULT 'ACTIVE' NOT NULL,
    ...
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT check_years_experience_positive CHECK (years_experience IS NULL OR years_experience >= 0),
...
-- 4. Worker Skills Junction Table (Normalized skills)
